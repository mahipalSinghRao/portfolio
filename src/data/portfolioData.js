...
export const experience = [
  {
    ...
    company: "Red & White Multimedia Pvt. Ltd.",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Engineered a scalable MERN-based admin and user platform with optimized backend workflows, improving resource management efficiency by 30%. Built clean dashboards and streamlined API interactions for real-time control.",
  ...
  {
    title: "Olivia E-Commerce Platform",
    period: "Sep 2023 — Nov 2023",
    description:
      "Developed a full-scale MERN e-commerce application with optimized product flows and Redux-based state management. Focused on performance and seamless user interaction across devices.",
...

  {
    ...
    description:
      "Built a dynamic admin portal to manage portfolio content including projects, experience, and skills without code changes. Designed scalable backend APIs with structured MongoDB collections.",
    stack: ["React", "Redux", "Tailwind", "Node.js", "Express", "MongoDB"],
    highlights: [
...

  {
    ...
    period: "Aug 2023",
    description:
      "Built a responsive movie search application using React and Context API, improving user engagement by 20% with efficient state handling and smooth UI rendering.",
...

  {
    ...
    period: "Aug 2023",
    description:
      "Designed a dynamic and responsive YouTube-like interface using React, focusing on UI structuring, layout systems, and cross-device compatibility.",
...
export const education = [
  {
    degree: "Full Stack Development & Product Engineering",
    institute: "Pesto Tech Online",
    location: "Bhilwara, India",
  ...
  },
  {
    ...
    institute: "Dr. CV Raman University",
    location: "Surat, India",
